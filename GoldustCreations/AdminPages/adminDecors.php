...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content container-fluid">
     <a href="addDecors.php" class="btn btn-block btn-primary btn-lg" data-toggle="modal" data-target="#addDecors">Add Decors</a>
     <!-- Modal -->
  <div class="modal fade" id="addDecors" role="dialog">
