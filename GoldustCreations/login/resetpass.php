...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
            <legend class="login100-form-title p-b-32">Reset Password</legend>
            <div>
                <span class="txt1 p-b-11">Forgot your password?</span>
                <p>Enter your username and we will let the admin reset your password for you.</p>
                <br>
            <div>
