                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php
                            ...
                            $sql = "SELECT register_id, lastName, firstName, username, email, age, gender, address, contactNumber, status, typeOfuser FROM registration where typeOfuser = 'customer' AND status='Pending'";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                    echo "<form action='acceptdeclineCustomer.php'><tr><td>" . $row["register_id"]. "</td><td>" . $row["lastName"]. "</td><td>" . $row["firstName"]. "</td><td>" . $row["username"]. "</td>
