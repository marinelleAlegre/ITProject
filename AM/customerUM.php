                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php
                            ...
                            $sql = "SELECT register_id, lastName, firstName, username, email, age, gender, address, contactNumber, status, typeOfuser from registration where status = 'Accepted' and typeOfuser = 'Customer'";
                            $result = $con->query($sql);

                            if ($result->num_rows > 0) {
                               echo "<table><tr><th>ID</th><th>Customer Name</th><th>Username</th><th>Email</th><th>Age</th><th>Gender</th>
