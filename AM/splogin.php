...
<?php
	...
	//Checking is user existing in the database or not
        ...
        if($rows==1){
			...
			header("Location: http://10.10.22.177:1111"); // Redirect user to index.php
            }else{
				echo "<div class='form'><h3>Username/password is incorrect.</h3><br/>Click here to <a href='splogin.php'>Login</a></div>";
				}
    }else{
?>
	<div class="form">
